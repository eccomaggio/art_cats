...
def main():
    ...
    settings.default_template = [
        ...
        (COL.title,                 (1, 3), 1, 0, "line"),
        (COL.tr_title,              (1, 3), 1, 3, "line"),
        (COL.subtitle,              (1, 3), 2, 0, "line"),
        (COL.tr_subtitle,           (1, 3), 2, 3, "line"),
        (COL.parallel_title,        (1, 3), 3, 0, "line"),
        (COL.tr_parallel_title,     (1, 3), 3, 3, "line"),
        (COL.parallel_subtitle,     (1, 3), 4, 0, "line"),
        (COL.tr_parallel_subtitle,  (1, 3), 4, 3, "line"),
        (COL.country_name,          (1, 2), 9, 0, "line"),
        (COL.state,                 (1, 2), 9, 2, "line"),
        (COL.place,                 (1, 2), 9, 4, "line"),
        (COL.publisher,             (1, 4), 10, 0, "line"),
        (COL.pub_year,              (1, 1), 10, 4, "line"),
        (COL.copyright,             (1, 1), 10, 5, "line"),
        (COL.extent,                (1, 1), 11, 1, "line"),
        (COL.size,                  (1, 1), 11, 0, "line"),
        (COL.is_illustrated,        (1, 1), 11, 3, "combo"),
        (COL.series_title,          (1, 3), 5, 0, "line"),
        (COL.series_enum,           (1, 2), 5, 3, "line"),
        (COL.volume,                (1, 1), 5, 5, "line"),
        (COL.notes,                 (3, 3), 6, 0, "text"),
        (COL.sales_code,            (1, 1), 12, 2, "line"),
        (COL.sale_dates,            (1, 2), 12, 4, "line"),
        (COL.hol_notes,             (3, 3), 6, 3, "text"),
        (COL.donation,              (1, 4), 13, 0, "line"),
        (COL.barcode,               (1, 2), 13, 4, "line"),
    ]
