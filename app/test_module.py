import pytest
from excel_to_marc21 import run, Record, apply_marc_logic

"""
if problems locating pytest, ensure environment is set as ./.venv/bin/python
"""

def is_valid_record(record):
  mark_record = apply_marc_logic(record)
  return mark_record

@pytest.mark.parametrize("valid_records", [
    ...
    ["ARTBL", "English / Dutch", "", "Rugs and carpets", "", "From the collection of the late Mr. P. Otten, Amsterdam.", "", "Tapijten ", "", "Uit de verzameling van wijlen de heer Mr. P. Otten te Amsterdam", "", "Netherlands", "Amsterdam", "Sotheby Mak Van Waay B.V.", "1987?", "© 1987", "12 pages", "27cm", "", "", "", "461", "19870706", "", "Donated by the Ashmolean Museum.", "308241036"],
    ["ARTBL", "English / Chinese", "", "Southeby's Hong Kong autumn sales 2013", "", "40: Sotheby's 40 years in Asia", "", "香港蘇富比2013秋李拍賣", "Xianggang Sufubi 2013 qiu ji pai mai", "40: 蘇富比亞洲四十年", "", "China", "Hong Kong", "Southeby's Hong Kong", "2013?", "", "42", "27cm", "", "", "", "", "20131004, 20131005, 20131006, 20131007, 20131008", "", "Donated by the Ashmolean Museum.", "308241086"]
])

def test_valid_records(valid_records):
  assert is_valid_record(valid_records)


# def is_invalid_record(record):
#   pass

# @pytest.mark.parametrize("invalid_records", [
#     Record(),
#     Record(),
#     Record(),
#     Record(),
...
# def test_invalid_records(invalid_records):
#   assert is_invalid_record(invalid_records)
